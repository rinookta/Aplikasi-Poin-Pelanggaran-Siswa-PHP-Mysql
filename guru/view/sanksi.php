        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"></span>&nbsp;Sanksi Pelanggaran</h3>
            </div>
            <!-- /.box-header -->
...
<?php $smk=mysqli_query($con,"SELECT * FROM sanksi order by bobot_dari asc ");$vr=1;while($akh=mysqli_fetch_array($smk)){ ?>
                <tr>
                  ...
                  <td align="center">
                  <a class="btn btn-info btn-sm" data-target="#sanksi<?php echo $akh['c_sanksi']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-stats"></i> Lihat Sanksi</a></td>
                </tr>

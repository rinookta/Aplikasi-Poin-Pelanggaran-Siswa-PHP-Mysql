        ...
        <?php } $_SESSION['pesan'] = '';?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Data Guru</h3><span style="float:right;"><a href="<?php echo $basead.'guru'; ?>" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-th-list"></i> Lihat Guru</a></span>
            </div>
            <!-- form start -->
